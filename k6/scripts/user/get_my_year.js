...
// Performance Test : PERF-USER-GMYR-001
// Multiple users see their year content option simultaneously

// Env
const BASE_URL = __ENV.BASE_URL

// Test Config Data
const MAX_P95_RESPONSE_TIME = "400"
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/user/my_year`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get my year success": (r) => r.json("status") === "success",
    })
