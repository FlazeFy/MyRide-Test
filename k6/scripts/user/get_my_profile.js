...
// Performance Test : PERF-USER-GMPR-001
// Multiple users see their profile simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/user/my_profile`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get my profile success": (r) => r.json("status") === "success",
    })
