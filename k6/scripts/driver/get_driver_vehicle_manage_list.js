...
// Performance Test : PERF-DRVR-GDVM-001
// Multiple users see their driver and its vehicle manage list simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/driver/vehicle/list`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get driver vehicle manage list success": (r) => r.json("status") === "success",
    })
