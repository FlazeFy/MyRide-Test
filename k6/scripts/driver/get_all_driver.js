...
// Performance Test : PERF-DRVR-GADR-001
// Multiple users see their driver simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/driver`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get all driver success": (r) => r.json("status") === "success",
    })
