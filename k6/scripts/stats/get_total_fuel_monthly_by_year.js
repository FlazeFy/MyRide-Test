...
// Performance Test : PERF-STAS-GTFY-001
// Multiple users see total fuel monthly by year simultaneously

// Credentials
const BASE_URL = __ENV.BASE_URL
const year = 2026
const context = 'fuel_volume'
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/stats/total/fuel/monthly/${context}/${year}`
    const params = {
        headers: {
