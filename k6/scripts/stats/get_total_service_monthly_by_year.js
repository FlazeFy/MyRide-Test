...
// Performance Test : PERF-STAS-GTSY-001
// Multiple users see total service monthly by year simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/stats/total/service/monthly/${context}/${year}`
    const params = {
        headers: {
