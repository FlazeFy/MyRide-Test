...
// Performance Test : PERF-FUEL-GLFL-001
// Multiple users see their monthly fuel summary simultaneously

// Env
const BASE_URL = __ENV.BASE_URL
const month_year = "01-2026"
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/fuel/summary/${month_year}`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get all fuel success": (r) => r.json("status") === "success",
    })
