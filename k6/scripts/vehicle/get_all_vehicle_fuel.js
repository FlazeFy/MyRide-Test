...
// Performance Test : PERF-VHCL-GAVF-001
// Multiple users see their vehicle fuel list format simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/vehicle/fuel`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get all vehicle fuel success": (r) => r.json("status") === "success",
    })
