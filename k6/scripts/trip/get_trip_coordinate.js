...
// Performance Test : PERF-TRIP-GTCR-001
// Multiple users see trip coordinate simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/trip/coordinate`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get trip success": (r) => r.json("status") === "success",
    })
